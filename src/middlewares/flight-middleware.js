...
function validateCreateRequest(req,res,next){
    ...
    if(!req.body.boardingGate)
    {
        ...
        ErrorResponse.message='Something went wrong while creating airport'
        ErrorResponse.error=new AppError(['Boarding gate details not found in the incoming request'],StatusCodes.BAD_REQUEST)
        return res
                .status(StatusCodes.BAD_REQUEST)
                .json(ErrorResponse)
    }
     if(!req.body.totalSeats)
    {
        ...
        ErrorResponse.message='Something went wrong while creating airport'
        ErrorResponse.error=new AppError(['Total seat details not found in the incoming request'],StatusCodes.BAD_REQUEST)
        return res
                .status(StatusCodes.BAD_REQUEST)
                .json(ErrorResponse)
    }
